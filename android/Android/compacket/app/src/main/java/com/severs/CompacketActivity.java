...
public class CompacketActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_compacket);
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent intent = new Intent(CompacketActivity.this, PeripheralControlActivity.class);
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.ACCESS_COARSE_LOCATION)){
            ...
            builder.setOnDismissListener(new DialogInterface.OnDismissListener() {
                public void onDismiss(DialogInterface dialog) {
                    ...
                    ActivityCompat.requestPermissions(CompacketActivity.this, new String[]{Manifest.permission.ACCESS_COARSE_LOCATION}, REQUEST_LOCATION);
                }
            });
            builder.show();
        } else {
    ...
    private void showMsg(String msg) {
        ...
        ((TextView) CompacketActivity.this.findViewById(R.id.msgTextView)).setText(msg);
    }
	...
	private class ListAdapter extends BaseAdapter {
		...
		public View getView(int i, View view, ViewGroup viewGroup) {
			...
			if (view == null) {
				view = CompacketActivity.this.getLayoutInflater().inflate(
