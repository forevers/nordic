...
static void test_timeout_handler(TimerHandle_t xTimer)
{
	...
	{
		canonical_notification[i] = i + times;
	}
...
static void on_adv_evt(ble_adv_evt_t ble_adv_evt)
{
    ...
    switch (ble_adv_evt)
    {
        ...
        case BLE_ADV_EVT_IDLE:
        	/* BLE advertisement timeout will sleep the device, resets on coming out of sleep */
            sleep_mode_enter();
            break;
        default:
            break;
...
static void ble_evt_dispatch(ble_evt_t * p_ble_evt)
{
	...
	canonical_bluetooth_on_ble_evt(p_ble_evt);
	debug_bluetooth_on_ble_evt(p_ble_evt);
...
static void ble_stack_init(void)
{
    ...
    ble_enable_params.gatts_enable_params.attr_tab_size = 0x0B00;
